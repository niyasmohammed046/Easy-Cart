...
SECRET_KEY = ')ccq^i1_r^e-k#+b#plpn7*6ow5ej1pub#8e(wo2&6fe5+q(!w'
...
AUTH_USER_MODEL = 'accounts.Account'   # this is for custome user 
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'usernick2000@gmail.com'
EMAIL_HOST_PASSWORD = 'qowkbqeqiktxppxg'
EMAIL_USE_TLS = True